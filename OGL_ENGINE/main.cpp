...
public:
    void Animar(glm::mat4 view, glm::mat4 projection)
    {
        glm::vec3 Obra1 = models[0].getScale();
        ...
        else
        {
            ...
            if (Movb == Mova)
            {
                MovResul = Movb - MinMov;
                Movb = MovResul;
                Movimiento = true;
            }
        }
        models[0].setScale(Obra1);
    }
};
...
public:
    void Animar2(glm::mat4 view, glm::mat4 projection)
    {
        glm::vec3 Obra2= models[1].getPosition();
        ...
        else
        {
            ...
            if (Movb2 == Mova2)
            {
                MovResul2 = Movb2 - MinMov2;
                Movb2 = MovResul2;
                Movimiento2 = true;
            }
        }
        models[1].setPosition(Obra2);
    }
};
...
public:
    void Animar3(glm::mat4 view, glm::mat4 projection)
    {
        glm::vec3 Obra3 = models[2].getAngles();
        ...
        else
        {
            ...
            if (Movb3 == Mova3)
            {
                MovResul3 = Movb3 - MinMov3;
                Movb3 = MovResul3;
                Movimiento3 = true;
            }
        }
        models[2].setAngles(Obra3);
    }
};
...
int main()
{
    ...
    //:::: CREAMOS LA VENTANA:::://
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Mini Museo 3D", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            glm::vec3 museo;
            museo = models[1].getPosition();
            museo.x -= movement;
            models[1].setPosition(museo);
        ...
        {
            glm::vec3 museo;
            museo = models[1].getAngles();
            museo.y += 0.5;
            models[1].setAngles(museo);
        ...
        {
            glm::vec3 museo;
            museo = models[1].getScale();
            museo.x += movement;
            models[1].setScale(museo);
...
void initScene(Shader ourShader)
{
    ...
    //0
    models.push_back(Model("Obra01", "models/Obra01.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));
    //1
    models.push_back(Model("Obra02", "models/Obra02.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));
    //2
    models.push_back(Model("Obra03", "models/Obra03.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));

    //3
    models.push_back(Model("Cuarto", "models/Cuarto.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));
    
    //4
    models.push_back(Model("Piso", "models/Piso.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));
    
    //5
    models.push_back(Model("Pedestal01", "models/Pedestal01.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));
    //6
    models.push_back(Model("Pedestal02", "models/Pedestal02.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));
    //7
    models.push_back(Model("Pedestal03", "models/Pedestal03.obj", glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), 0.0f, initScale));
...
void loadEnviroment(Terrain* terrain, SkyBox* sky, glm::mat4 view, glm::mat4 projection)
{
    ...
    Obras01 Rotar;
    Rotar.Animar(view, projection);

    Obras02 Rotar2;
    Rotar2.Animar2(view, projection);

    Obras03 Rotar3;
    Rotar3.Animar3(view, projection);
